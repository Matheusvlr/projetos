...
b_2.place(x=118, y=0) # X horizontal, Y vertical
...
b_4.place(x=0, y=52) # X horizontal, Y vertical
...
b_5.place(x=59, y=52) # X horizontal, Y vertical
...
b_6.place(x=118, y=52) # X horizontal, Y vertical
...
b_7.place(x=177, y=52) # X horizontal, Y vertical
...
b_8.place(x=0, y=104) # X horizontal, Y vertical
...
b_9.place(x=59, y=104) # X horizontal, Y vertical
...
b_10.place(x=118, y=104) # X horizontal, Y vertical
...
b_11.place(x=177, y=104) # X horizontal, Y vertical
...
b_12.place(x=0, y=156) # X horizontal, Y vertical
...
b_13.place(x=59, y=156) # X horizontal, Y vertical
...
b_14.place(x=118, y=156) # X horizontal, Y vertical
...
b_15.place(x=177, y=156) # X horizontal, Y vertical
...
b_17.place(x=118, y=208) # X horizontal, Y vertical
...
b_18.place(x=177, y=208) # X horizontal, Y vertical
